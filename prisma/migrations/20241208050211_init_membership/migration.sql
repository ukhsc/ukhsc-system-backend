-- CreateEnum
CREATE TYPE "FederatedProvider" AS ENUM ('Google');
...
-- CreateIndex
CREATE UNIQUE INDEX "StudentMember_primary_email_key" ON "StudentMember"("primary_email");

-- CreateIndex
CREATE UNIQUE INDEX "PersonalMembershipOrder_member_id_key" ON "PersonalMembershipOrder"("member_id");

-- AddForeignKey
ALTER TABLE "FederatedAccount" ADD CONSTRAINT "FederatedAccount_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "StudentMember"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
