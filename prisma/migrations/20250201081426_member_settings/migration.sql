...
-- AddForeignKey
ALTER TABLE "MemberSettings" ADD CONSTRAINT "MemberSettings_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "StudentMember"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
